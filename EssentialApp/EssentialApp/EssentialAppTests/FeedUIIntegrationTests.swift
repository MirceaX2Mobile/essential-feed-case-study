...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadMoreActions_requestMoreFromLoader() {
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(loader.loadMoreCallCount, 2, "Expected request while loading more")
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(loader.loadMoreCallCount, 3, "Expected no request while loading more")
    }
    ...
    func test_loadingMoreIndicator_isVisibleWhileLoadingMore() {
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertTrue(sut.isShowingLoadMoreFeedIndicator, "Expected loading indicator once user initiates a reload")
        ...
        loader.completeLoadMoreWithError(at: 1)
        XCTAssertFalse(sut.isShowingLoadMoreFeedIndicator, "Expected loading indicator once user initiates a reload")
    }
    ...
    func test_feedImageView_loadsURLWhenVisibile() {
    ...
    func test_loadImageDataCompletion_dispatchesFromBackgroundThread() {
        let (sut, loader) = makeSUT()
    ...
    private func makeSUT(
        ...
        let sut = FeedUIComposer.feedComposerWith(
